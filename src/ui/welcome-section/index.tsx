  ...
  return (
    <div className="max-w-[1100px] flex flex-col items-center relative pt-32 px-16">
      <img
        ...
        className="absolute rotate-[180deg] w-[240px] right-[-160px] top-[-160px]"
      />

      <div className="flex flex-col items-center relative">
        <div className="flex flex-col absolute top-[-48px] z-100">
          <span className="great-vibes text-[48px] leading-12 text-red-800">
            Никита
          </span>
          <span className="great-vibes text-[48px] leading-12 text-red-800">
            Анастасия
